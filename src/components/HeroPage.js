...
export default function HeroPage() {
    ...
    return (
        <>
            <div className="heropagecontainer flex text-center justify-center">
                <NavBar />
                <div className="container flex flex-col justify-center text-center text-white" >
                    ...
                    <div className="description text-xl my-4 font-sans text-violet-200 sm:" data-aos="fade-left">
                    ...
                    <div className="portfolioandcv flex flex-col mx-20 sm:flex-row sm:justify-items-center sm:justify-center" data-aos="fade-up">
                        ...
                        <button className="bg-violet-500 hover:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300 p-5 text-xl font-bold rounded-3xl sm:mx-4 sm:my-10" >
                            <a href="https://drive.google.com/file/d/1gtFE3NG5_L00q2wh3eF3omWmIXcf0Pxx/view?usp=sharing" target="_blank">
                                📃View Resume
                            </a>
                        </button>
                    </div>
                    <div className="skills hidden sm:flex flex-row text-justify justify-between h-4 text-2xl flex-wrap text-violet-200 p-4 my-10" data-aos="fade-left">
